  ...
  return (
    <Cell {...props} className="link-group">
      <ButtonGroup>
        ...
        <IconButton icon={<LiaEdit color='green'/>} size='sm' appearance='subtle' title='Edit' onClick={()=>handleOpen(rowData._id,rowData.name,rowData.phone,rowData.event_date ? new Date(rowData.event_date) : null,rowData.no_of_guest,rowData.city,rowData.location,"Update")}/>
