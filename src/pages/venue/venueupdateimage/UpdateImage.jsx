...
export default function UpdateImage({ setName }) {
    ...
    useEffect(() => {
        const getImages = async () => {
            ...
            let venue = await fetch(`/api/venue/get-images/${_id}`)
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            const url = `/api/venue/upload-images/${_id}`;
    ...
    const handleDelete = async (imageName) => {
        ...
        try {
            ...
            const url = `/api/venue/delete-image/${_id}`;
    ...
    async function updateImagePosition(updateImageList) {
        ...
        try {
            ...
            //Making request to delte the images
            const url = `/api/venue/update-image/${_id}`;
