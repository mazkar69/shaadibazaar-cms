...
export default function AddUserModal({open, handleClose,refetch}) {
    ...
    const handleSubmit = async (value) => {
        ...
        try {
            setLoading(true);
            const { data } = await authApi.post("/api/adminUser/create", formData);
            ...
            <Modal.Body>
                <Form fluid formValue={formData} onChange={setFormData}>
                    ...
                    <Form.Group controlId="role" >
                        ...
                        <Form.Control name="role" accepter={SelectPicker} data={role}  block searchable={false} />
                    </Form.Group>
                </Form>
            </Modal.Body>
            <Modal.Footer>
